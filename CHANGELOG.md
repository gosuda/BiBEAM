...
## [0.0.1](https://github.com/gosuda/BiBeam/releases/tag/bibeam-core-v0.0.1) - 2026-05-18
...
- *(bibeam-core)* move SessionClaims from bibeam-protocol to bibeam-core (fix crypto→protocol layering inversion)
- *(crates)* drop pre-D-4 QUIC/Noise rustdoc residue across source files
