...
//! protocol / storage / io — so downstream callers can match on the cause
//! without needing to know the precise sub-error type. Each variant carries
//! a human-readable string except [`Error::Io`], which re-wraps
